...
This mechanism has been integrated into Bitcore-Node-SteelHorseCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/steelhorsecoinpay/insight-api-steelhorsecoin#web-socket-api](https://github.com/steelhorsecoinpay/insight-api-steelhorsecoin#web-socket-api)
* API: [https://github.com/steelhorsecoinpay/insight-api-steelhorsecoin#instantsend-transactions](https://github.com/steelhorsecoinpay/insight-api-steelhorsecoin#instantsend-transactions)
...
By default, the SteelHorseCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the SteelHorseCoin Core daemon:
