...
2. run steelhorsecoind with -printalert or -sendalert like this:
   /path/to/steelhorsecoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.steelhorsecoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/SteelHorseCoin Core:0.12.0.58/"));
