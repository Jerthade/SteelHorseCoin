...
This document provides guidelines for internationalization of the SteelHorseCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `steelhorsecoin_en.ts` remains unchanged.
