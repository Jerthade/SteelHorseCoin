...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in steelhorsecoin.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("steelhorsecoin.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    ...
    { "steelhorsecoin",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "steelhorsecoin",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "steelhorsecoin",               "gobject",                &gobject,                true,  {} },
    { "steelhorsecoin",               "voteraw",                &voteraw,                true,  {} },
