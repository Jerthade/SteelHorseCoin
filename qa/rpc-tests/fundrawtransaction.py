...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid steelhorsecoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid steelhorsecoin address" in e.error['message'])
