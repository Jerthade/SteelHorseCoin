    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  steelhorsecoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the SteelHorseCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 STHC, 0.1 STHC, 1 STHC and 10 STHC -- sort of like the paper money you use every day.</li> \
