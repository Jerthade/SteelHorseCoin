/* src/config/steelhorsecoin-config.h.  Generated from steelhorsecoin-config.h.in by configure.  */
/* src/config/steelhorsecoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef STHC_CONFIG_H

#define STHC_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The SteelHorseCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "SteelHorseCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/steelhorsecoinpay/steelhorsecoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "SteelHorseCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "SteelHorseCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "steelhorsecoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://steelhorsecoin.org/"
