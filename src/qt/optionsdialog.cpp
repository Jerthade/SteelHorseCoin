    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("STHC-light"), QVariant("light"));
    ui->theme->addItem(QString("STHC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("STHC-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("STHC-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("STHC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("STHC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("STHC-traditional"), QVariant("trad"));
