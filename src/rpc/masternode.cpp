...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print SteelHorseCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "steelhorsecoin",               "masternode",             &masternode,             true,  {} },
    { "steelhorsecoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "steelhorsecoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "steelhorsecoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "steelhorsecoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "steelhorsecoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
